...
<div class="site-content">
        <div class="panel panel-default">
          ...
          <div class="panel-body">            
            <div class="row">
              <?php $getContents = getDataFromTables('faqs',$status=NULL,'id',$id,$activeStatus=NULL,$activeTop=NULL);
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="question" class="form-control" id="form-control-2" data-error="Please enter a Question" required value="<?php echo $getContents1['question'];?>">
                    <div class="help-block with-errors"></div>
                  </div>

                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Answer</label>
                    <textarea name="answer" class="form-control" id="description" data-error="Please enter Answer." required><?php echo $getContents1['answer'];?></textarea>
                    <div class="help-block with-errors"></div>
                  </div>
